...
2. Install `StadiumAnnouncer-v2.0.0.zip` as a Gen1Recomp mod.
3. Enable **Stadium Announcer** in the Mod Manager.
4. Configure **ANNOUNCER BATTLES** in the mod options if desired.
